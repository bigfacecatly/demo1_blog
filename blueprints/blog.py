...
from flask import render_template,Blueprint,request,about,make_response
...
from bluelog.util import redirect_back
...
def show_post(post_id):
	...
	return render_template('blog/post.html',post=post,pagination=pagination,comments=comments,forms=forms)


@blog_bp.route('/reply/comment/<int:comment_id>')
def reply_comment(comment_id):
	comment = Comment.query.get_or_404(commit_id)
